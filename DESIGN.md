...
colors:
  ...
  text-heading: "#27302b"
  text-warm: "#27302b"
  text-secondary: "#414b45"
  text-muted: "#4f5a53"
  text-disabled: "#7a7d73"
  text-inverse: "#ffffff"
  ...
  accent: "#7e4718"
  action-fill: "#9d5c25"
  action-strong: "#633812"
  action-subtle-bg: "#dde5dc"
  action-subtle-hover: "#c3cdc2"
  cta-bg: "#a9c4b1"
  cta-hover: "#93b39d"
  cta-border: "#83a38f"
  border-subtle: "#c3cdc2"
  border-card: "#c3cdc2"
  border-control: "#4f5a53"
  border-disabled: "#c3cdc2"
  tint-butter: "#f0e1c3"
  tint-blush: "#f2dcd4"
  tint-sage: "#dde5dc"
  selected-text: "#7e4718"
  focus: "#3d6a8c"
  decor-thread: "#9d5c25"
  decor-art-line: "#83a38f"
  decor-wave: "#dde5dc"
  decor-halo: "rgba(169, 196, 177, 0.45)"
  overlay: "rgba(39, 48, 43, 0.32)"
  shadow-soft: "rgba(39, 48, 43, 0.14)"
  scrollbar-thumb: "#93b39d"
  scrollbar-track: "#f0eee9"
  shadow-page: "#c3cdc2"
  shadow-sunken: "#c3cdc2"
  shadow-inverse: "#27302b"
  shadow-cream: "#c3cdc2"
  shadow-warm: "#c3cdc2"
typography:
  commerce-badge:
